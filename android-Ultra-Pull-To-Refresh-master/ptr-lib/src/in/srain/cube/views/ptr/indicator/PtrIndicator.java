...
public class PtrIndicator {
    ...
    public boolean hasJustLeftStartPosition() {
        return mLastPos == POS_START && true;
    }
    ...
    public int getOffsetToKeepHeaderWhileLoadingFoot() {
        return mOffsetToKeepHeaderWhileLoading >= 0 ? mOffsetToKeepHeaderWhileLoading : mFootHeight;
    }
