 ...
 */
public class PtrClassDefaultFoot extends FrameLayout implements PtrUIHandlerFoot {
    ...
    public PtrClassDefaultFoot(Context context) {
        super(context);
        initViews(null);
    }

    public PtrClassDefaultFoot(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrClassDefaultFoot(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.default_foot, this);
